...
import com.pacmanproject.main.Ghost;
import com.pacmanproject.main.Location;
import com.pacmanproject.main.Map;
...
public class GhostTest  {
	...
	{
		Location ghostlocation = new Location(1,3);
		Ghost ghost = new Ghost(ghostlocation); 
	...
	{
		Location ghostlocation = new Location(1,13);
		Ghost ghost = new Ghost(ghostlocation);
	...
	{
		Location ghostlocation = new Location(4,3);
		Ghost ghost = new Ghost(ghostlocation);
		ghost.moveRight();
		assertEquals (4, ghost.getCoordinate().getYlocation(), 0.001);
	}
